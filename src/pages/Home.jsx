        ...
        <div style={{ width: '100%' }}>
          <div className="container" style={{ position: 'relative', zIndex: 10 }}>
            ...
            <div className="flex-mobile-col" style={{ display: 'flex', gap: '2rem' }}>
              <Link to="/signup#order-form" className="btn" style={{ padding: '2rem 4rem', fontSize: '2rem', backgroundColor: 'transparent', color: 'var(--color-black)', border: '4px solid var(--color-lime)' }}>
                BUY NOW
              </Link>
            </div>
          </div>
