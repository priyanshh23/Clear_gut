    ...
    <div className="bg-white" style={{ minHeight: '100vh', position: 'relative' }}>
        ...
        <div style={{ width: '100%' }}>
          <div className="container" style={{ position: 'relative', zIndex: 10 }}>
            <div style={{ maxWidth: '520px' }}>
              <h1 className="text-hero" style={{ color: 'var(--color-black)', textShadow: '4px 4px 0 var(--color-lime)', marginBottom: '2rem', lineHeight: 0.9 }}>
            ...
            <div className="flex-mobile-col" style={{ display: 'flex', gap: '2rem' }}>
              <Link to="/shop" className="btn btn-primary" style={{ padding: '2rem 4rem', fontSize: '2rem' }}>
                BUY NOW
              </Link>
            </div>
            <div className="flex-mobile-col" style={{ marginTop: '4rem', display: 'flex', gap: '3rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', fontFamily: 'var(--font-heading)', fontSize: '1.5rem', textShadow: '0 2px 10px rgba(255,255,255,0.8)' }}>
                <Skull className="text-black" size={32} /> ZERO BS
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', fontFamily: 'var(--font-heading)', fontSize: '1.5rem', textShadow: '0 2px 10px rgba(255,255,255,0.8)' }}>
                <Zap className="text-lime" size={32} /> RAW POWER
              </div>
            </div>
          </div>

          {/* This image only displays on mobile to prevent background overlapping issues */}
          <div className="mobile-hero-img">
            <img className="mobile-hero-image" src="/hero_bg.png" alt="Clear Gut Hero" />
          </div>
        </div>
        </div>
      </section>
      ...
      <section className="bg-white section-padding" style={{ borderTop: '4px solid var(--color-black)' }}>
        <div className="container">
          <h2 className="text-title" style={{ marginBottom: '4rem', textAlign: 'center', textShadow: '4px 4px 0 var(--color-lime)' }}>WHY <span className="text-lime" style={{ textShadow: '4px 4px 0 var(--color-black)' }}>CLEAR GUT?</span></h2>
      ...
      <section className="bg-black section-padding" style={{ color: 'var(--color-white)', borderTop: '4px solid var(--color-lime)' }}>
        <div className="container">
          <div className="flex-mobile-col" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '6rem', gap: '2rem' }}>
            <div>
