  ...
  return (
    <div className="bg-white section-padding" style={{ minHeight: '100vh', position: 'relative' }}>
      ...
      <div className="container" style={{ maxWidth: '900px', position: 'relative', zIndex: 10 }}>
        <h1 className="text-hero" style={{ textAlign: 'center', marginBottom: '4rem', color: 'var(--color-black)', textShadow: '6px 6px 0 var(--color-lime)', lineHeight: 0.9 }}>
          THE <br/><span className="text-lime" style={{textShadow: '6px 6px 0 var(--color-black)'}}>MANIFESTO</span>
        </h1>
        
        <div className="text-body" style={{ fontWeight: 'bold', display: 'flex', flexDirection: 'column', gap: '3rem', borderLeft: '8px solid var(--color-black)', paddingLeft: '2rem' }}>
          <p>
          ...
          <div className="brutal-border" style={{ padding: '2rem', backgroundColor: 'var(--color-white)', marginTop: '2rem', textAlign: 'center', transform: 'rotate(1deg)' }}>
            <Skull size={64} className="text-black" style={{ margin: '0 auto 2rem' }} />
            <h3 className="text-subtitle" style={{ marginBottom: '1rem', lineHeight: 1 }}>YOUR GUT CALLED. IT'S PISSED OFF.</h3>
          ...
          <h2 className="text-title" style={{ marginTop: '4rem', color: 'var(--color-black)' }}>RAW <span className="text-lime" style={{textShadow: '2px 2px 0 var(--color-black)'}}>POWER</span></h2>
          <p>
